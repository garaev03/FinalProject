...
using Business.Utilities.Validations.VehicleReportValidations;
...
namespace TurboAzClone.Areas.Admin.Controllers
{
    ...
    public class VehicleReportsController : Controller
    {
        ...
        private readonly VehicleReportPostDtoValidation _validator;
        public VehicleReportsController(IVehicleReportService service, VehicleReportPostDtoValidation validator)
        {
            _service = service;
        ...
        [HttpPost]
        public async Task<IActionResult> Create(VehicleReportPostDto postDto)
        {
        ...
        {
            VehicleReportUpdateDto updateDto = new VehicleReportUpdateDto();
        ...
        [HttpPost]
        public async Task<IActionResult> Update(VehicleReportUpdateDto updateDto)
        {
