...
using Business.Utilities.Validations.OwnerCountValidations;
...
{
    [Area("Admin")]
    public class OwnerCountsController : Controller
    {
        private readonly IOwnerCountService _service;
        private readonly OwnerCountPostDtoValidation _validator;
        public OwnerCountsController(IOwnerCountService service, OwnerCountPostDtoValidation validator)
        {
            _service = service;
        ...
        [HttpPost]
        public async Task<IActionResult> Create(OwnerCountPostDto postDto)
        {
        ...
        {
            OwnerCountUpdateDto updateDto = new OwnerCountUpdateDto();
        ...
        [HttpPost]
        public async Task<IActionResult> Update(OwnerCountUpdateDto updateDto)
        {
