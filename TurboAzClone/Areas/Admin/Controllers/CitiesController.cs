...
using Business.Utilities.Validations.CityValidations;
...
namespace TurboAzClone.Areas.Admin.Controllers
{
    ...
    public class CitiesController : Controller
    {
        ...
        private readonly CityPostDtoValidation _validator;
        public CitiesController(ICityService service, CityPostDtoValidation validator)
        {
            _service = service;
