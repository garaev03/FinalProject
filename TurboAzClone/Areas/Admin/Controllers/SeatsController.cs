...
using Business.Utilities.Validations.SeatValidations;
...
namespace TurboAzClone.Areas.Admin.Controllers
{
    ...
    public class SeatsController : Controller
    {
        ...
        private readonly SeatPostDtoValidation _validator;
        public SeatsController(ISeatService service, SeatPostDtoValidation validator)
        {
            _service = service;
        ...
        [HttpPost]
        public async Task<IActionResult> Create(SeatPostDto postDto)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(SeatUpdateDto updateDto)
        {
