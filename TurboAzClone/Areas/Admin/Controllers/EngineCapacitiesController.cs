...
using Business.Utilities.Validations.EngineCapacityValidations;
...
namespace TurboAzClone.Areas.Admin.Controllers
{
    ...
    {
        private readonly IEngineCapacityService _service;
        private readonly EngineCapacityPostDtoValidation _validator;
        public EngineCapacitiesController(IEngineCapacityService service, EngineCapacityPostDtoValidation validator)
        {
            _service = service;
        ...
        [HttpPost]
        public async Task<IActionResult> Create(EngineCapacityPostDto postDto)
        {
        ...
        {
           EngineCapacityUpdateDto updateDto = new EngineCapacityUpdateDto();
        ...
        [HttpPost]
        public async Task<IActionResult> Update(EngineCapacityUpdateDto updateDto)
        {
